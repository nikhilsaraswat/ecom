        ...
        <div class="row" style="height:75vh">
            ...
            <div class="col-md-10">
                <div class="border-bottom px-4 py-2 font-bold text-xl d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('adminvariationpanelcreate') }}">
                        ...
                        <tbody>
                            @forelse ($dataofuser as $user)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="card-body">
                                            <form method="post" action="/admin/variabledelete/{{ $user->id }}"
                                                class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-danger"><i
                                                        class="fas fa-trash-alt"></i>Delete</button>
                                            </form>
                                            <a href="/admin/{{ $user->id }}/variableedit"
                ...
                <script>
                    ...
                    var split_string = str1.split(";").trim();
                    dd($split_string);
                </script>
