...
<div class="container-fluid">
  ...
  @include("../components/sidebar")
    ...
    <div style="overflow-y: auto; height:75vh;">
      <div class="h-100">
    <form method="POST" enctype="multipart/form-data" class="h-90 flex flex-column items-center space-y-2 p-3 bg-white" action="/admin/variableproductedit/{{ $productlistfromdatabase->id }}" >
  @csrf
  @method('PUT')
